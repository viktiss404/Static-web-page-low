<?
			...
			mail("info@creant.ru", "Отзыв в Anker Aqua", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

				$fp = fopen("cmnt/comments_Anker_aqua.txt", "a+"); // режим записи
			...
			$fp = @fopen("cmnt/comments_Anker_aqua.txt", "r"); // режим чтения
			if ($fp) {
				while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <meta name="keywords" content="купить regbnm заказать приобрести Creanit creanit скуфтше [bvbxtcrbq fyrth химический анкер Anker Aqua EXW-385 влажность воды вода">
      <meta name="description" content="Creanit Anker Aqua EXW-385 химический анкер для анкерных креплений под водой и в основаниях с высокой влажностью">
	  <title>Химический анкер Creant CREANIT™ Anker EXW-385</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Creanit">Creanit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/Anker_EX_Aqua.php" style="text-decoration: underline;">Anker EXW-385</a></li>
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">CREANIT™ Anker EXW-385</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Creanit/Aqua_box_low.jpg" width="210" xoriginal="img/Creanit/Aqua_box.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Creanit/Aqua_box.jpg"><img class="xzoom-gallery3" width="100" src="img/Creanit/Aqua_box_low.jpg"  xpreview="img/Creanit/Aqua_box_low.jpg" title="рисунок1"></a>
                                    <a href="img/Creanit/Aqua.jpg"><img class="xzoom-gallery3" width="100"  src="img/Creanit/Aqua_low.jpg" title="рисунок2"></a>
                                </div>
                        </div>
                    </div>
...
<h1 class="card-title text-center sct">CREANIT™ Anker<br> EXW-385</h1>
</div>
<div class="card-body" >
<a class="oie">Профессиональный химический анкер для анкерных креплений под водой и в основаниях с высокой влажностью.</a> 
</div>
	...
	<tbody style="text-align: center; ">
			<tr>
				...
				<td style="padding:0px;">
					...
					data-sb-id-or-vendor-code="К-01003"
					data-sb-product-name="CREANIT Anker EXW-385"
					data-sb-product-price="1900"
					data-sb-product-quantity= "1"
					data-sb-product-img="img/Creanit/Aqua.jpg">
					Добавить в корзину
					</a>
				</td>							
			</tr>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							...
							<p>
							Специально разработан для применения в отверстиях,
                            выполненных с использованием установок алмазного бурения и
                            имеющих гладкую отшлифованную внутреннюю поверхность.
							</p>
							<p>
							Применяется для установки закладных анкерных и фундаментных болтов больших диаметров, крепления промышленного
                            оборудования, организации арматурных выпусков при монолитном строительстве и реконструкции промышленных зданий и
                            сооружений, аэропортов, морских и речных портов, объектов
                            транспортной инфраструктуры, энергетических и военных
                            объектов.
							</p>
...
спустя 1,5 часа после инъекции состава,
