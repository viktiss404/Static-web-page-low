<?
					...
					mail("info@creant.ru", "Отзыв в Удлинитель миксера длинный", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_miks_nasad_ydl.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_miks_nasad_ydl.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести оборудование миксер насадка-удлинитель сместитель сместитель-насадка cvtcnbntkm cvtcnbntkm-yfcflrf vbrcth yfcflrf [bvbxtcrbq fyrth химический анкер yfcflrf-elkbybntkm насадка yfcflrf">
        <meta name="description" content="Удлинитель смесителя-насадки ORBIS 1000 для работы с химическими анкерами">
        <title>Удлинитель смесителя-насадки</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Oborud">Оборудование</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/miks_nasad_ydl.php" style="text-decoration: underline;">Удлинитель миксера</a></li>
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Насадка-удлинитель миксера</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/teh_obsl/ydl_miks_low.gif" width="210" xoriginal="img/teh_obsl/ydl_miks.gif" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/teh_obsl/ydl_miks.gif"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/ydl_miks_low.gif"  xpreview="img/teh_obsl/ydl_miks_low.gif" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="card ">
                      <div class="card-title">
                        <h1 class="card-title text-center sct">Насадка-удлинитель миксера</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Удлинитель смесителя-насадки ORBIS 1000</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >ORBIS 1000</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">250</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="О-01003"
											data-sb-product-name="ORBIS Удлиненный"
											data-sb-product-price="250"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/ydl_miks.gif">
											Добавить в корзину
											</a>
										</td>							
									</tr>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>ОПИСАНИЕ</h2> </center>
						<div class="card-body p-40">
							<p >  Удлинитель для смесителя ORBIS является дополнительным компонентом для картриджей, который который удлиняет разъем и выход вещества. За счет этого, достаточно легко дотянуться к трудно досягаемым участкам выбранных объектов.
							</p>
							<p >   Удлинитель является универсальным и по своей конструкции подходит для всех типов картриджей. Его длина составляет 1000 мм, что является оптимальным решением для оптимизации рабочего процесса.
							</p>
							<p >  Разработан смеситель ORBIS из высококачественного и прочного пластика, который имеет достаточную степень противостояния различным химическим реагентам, и также погодным условиям в виде пониженных температур.
							</p>
						</div>
           			 </div>
                    </div>
