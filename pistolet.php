<?
					...
					mail("info@creant.ru", "Отзыв в пистолете", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_pist.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_pist.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<meta name="keywords" content="купить regbnm заказать приобрести оборудование пистолет для gbcnjktn lkz [bvbxtcrjuj fyrthf химический анкер Пистолет Gbcnjktn выпрессовывания dsghtccdsdfybt картриджей rfhnhbl;tq rfhnhbl; картридж">
<meta name="description" content="Пистолет для выпрессовывания картриджей">
<title>Пистолет</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Oborud">Оборудование</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/pistolet.php" style="text-decoration: underline;">Пистолет</a></li>
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Пистолет</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/teh_obsl/Pist_dl_kompr2_low.jpg" width="210" xoriginal="img/teh_obsl/Pist_dl_kompr2.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/teh_obsl/Pist_dl_kompr2.jpg"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/Pist_dl_kompr2_low.jpg"  xpreview="img/teh_obsl/Pist_dl_kompr2_low.jpg" title="рисунок1"></a>
                                    
				                    <a href="img/teh_obsl/Pist_dl_kompr.jpg"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/Pist_dl_kompr_low.jpg"  title="рисунок2"></a>
                                </div>
                        </div>
                    </div>
...
<div class="card ">
                      ...
                      <div class="card-title">
                        <h1 class="card-title text-center sct">Пистолет</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Пистолет для выпрессовывания картриджей</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >Модель CR-585</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">6400</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="О-01001"
											data-sb-product-name="CR-585"
											data-sb-product-price="6400"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/Pist_dl_kompr2.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>ОПИСАНИЕ</h2> </center>
						<div class="card-body p-40">
							<p >  Предназначен для выпрессовывания сдвоенных картридже объемом 385 мл. и 585 мл. в соотношении 3:1. 
							</p>
							<p >  Конструкционные особенности пистолета выполнены со всеми показателеми прочности и надежности, за счет чего данный пистолет прослужит достаточно длительный период времени.
							</p>
							<p >  При использовании данного пистолета работа монтажника существенно облегчается, так как химические составы обладают высокой вязкозтью, а обычные пистолеты не способны выпрессовывать компоненты с высокой скоростью.
							</p>
						</div>
           			 </div>
                    </div>
