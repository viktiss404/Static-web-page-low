<?
					...
					mail("info@creant.ru", "Отзыв в Antic", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Antic.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Antic.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <meta name="keywords" content="купить regbnm заказать приобрести Creanit creanit скуфтше [bvbxtcrbq fyrth химический анкер клей Antic приклеивание скрепление закрепление ghbrktbdfybt rhtgktybt rktq 'gjrcblysq">
      <meta name="description" content="Creanit Anker Antic двухкомпонентный эпоксидный клей предназначеный для приклеивания напольных и настенных покрытий и на различные виды оснований">
      <title>Химический анкер Creant CREANIT™ Antic</title>
    ...
    <nav class="navbar navbar-expand-lg spacer one">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Creanit">Creanit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/Creanit_Antic.php" style="text-decoration: underline;">Antic</a></li>
                                    </ul>
                                </li>
                                </ul>
        ...
        <div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">CREANIT Antic</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Creanit/CREANIT_Antic_low.jpg" width="210" xoriginal="img/Creanit/CREANIT_Antic.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Creanit/CREANIT_Antic.jpg"><img class="xzoom-gallery3" width="100" src="img/Creanit/CREANIT_Antic_low.jpg"  xpreview="img/Creanit/CREANIT_Antic_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
					
                      <div class="card-body">
					  	Артикул: К-01006,К-01007
                      </div>
                  </div>
                  <div class="card w-20">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">CREANIT Antic</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Двухкомпонентный эпоксидный клей предназначен для приклеивания напольных и настенных покрытий покрытий на впитывающие и невпитывающее основания (бетон, цементная, гипсовая стяжка, асфальт, дерево, мрамор, гранит, керамика, металл и т.д.). Применяется как для наружных работ, так и для работ внутри помещения.</a> 
					  </div>
					  <table class="table table-bordered w-100"style="margin-bottom:0px;">
							...
							<tbody style="text-align: center; ">
									...
									<td style=" vertical-align: middle;" >1800 гр</td>						
										...
										<td >
											...
											data-sb-id-or-vendor-code="К-01006"
											data-sb-product-name="CREANIT Antic"
											data-sb-product-price="3200"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/CREANIT_Antic.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
						...
						<thead class="thead-dark">
							...
							<tr>
										...
										<td >
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;"
											data-sb-id-or-vendor-code="К-01007"
											data-sb-product-name="CREANIT Antic"
...
<div class="tab-content" id="nav-tabContent">
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p    >  Двухкомпонентный эпоксидный клей предназначен для приклеивания напольных и настенных покрытий покрытий на впитывающие и невпитывающее основания (бетон, цементная, гипсовая стяжка, асфальт, дерево, мрамор, гранит, керамика, металл и т.д.). 
							</p>
							<p     >  Применяется как для наружных работ, так и для работ внутри помещения. 
							</p>
						</div>
           			 </div>
                    ...
                    <div class="card-body p-40">
						<ul class="p-40">
							<li>
								<p   >  Используется для укладки:
                                        Керамогранита, керамической плитки, мрамора, мозаики и клинкера на цементные поверхности, штукатурку, бетон, ацеид, ЦСП, ДСП, ОСП, фанеру, 
                                        дерево, асфальт, ПВХ, металлические листы, а также поверхности, подверженные воздействию вибрации. 
								</p>
							<li>
								<p   >   Для приклеивания Тактильной плитки из компазита.  
								</p>
							<li>
								<p   >   крепления
  ...
  <div class="row mb-2">
	...
	<li>
<p   >   температура
	применения: от + 10 до + 40°С.   
	</p>
	<li>
<p   >   Рабочее время: 10 минут (чем больше объем смеси, тем меньше время жизнеспособности в общей массе).  
	</p>
	<li>
...
<p   >   Цвет
	– серый  </p>
		<li>
<p   >   Условия эксплуатации: от - 40 до + 50°С.</p>
</ul>
                    </div>
            </div>
                    ...
                    <ul  class="p-40">
	<li/>
<p   >   Отмерить нужное количество компонента А и Б.
	  
	</p>
	<li/>
<p   >    Прогреть компонент А феном.  
	</p>
	<li/>
<p   >    Добавить компонент Б в компонент А.  
	</p>
	<li/>
<p   >    Перемешать два компонента пока состав не станет однородным по цвету и внешнему виду. 
...
При перемешивании необходимо захватывать участки около стенок и на дне емкости с клеем.
	...
	<li/>
<p   >   Следует избегать образования пузырей.</p>
		<li/>
<p   >   Вылить необходимое количество сотстава на поверхность и равномерно распределить его используя шпатель.</p>
		<li/>
<p   >   Клеевой состав рекомендуется использовать в течение его жизнеспособности – от 2 до 10 минут. При повышении температуры время жизнеспособности клея сокращается. </p>
		<li/>
<p   >   При использовании применять средства индивидуальной защиты (перчатки, очки).</p>
</ul>
                    </div>
			</div>
