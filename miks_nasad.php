...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести оборудование миксер сместитель сместитель-насадка cvtcnbntkm cvtcnbntkm-yfcflrf vbrcth yfcflrf [bvbxtcrbq fyrth химический анкер">
        <meta name="description" content="Смеситель-насадка ORBIS для работы с химическими анкерами">
        <title>Смеситель-насадка</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Миксер-насадка</h1>

					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/teh_obsl/micks_low.jpg" width="210" xoriginal="img/teh_obsl/micks.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/teh_obsl/micks.jpg"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/micks_low.jpg"  xpreview="img/teh_obsl/micks_low.jpg" title="рисунок1">
                                    </a>
                                </div>
                        </div>
                    </div>
  ...
  Артикул: О-01002
                  ...
                  <div class="card">
                      ...
                      <div class="card-title">
                        <h1 class="card-title text-center sct">Миксер-насадка</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Смеситель-насадка для картриджей ORBIS 12-24</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >ORBIS 12-24</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">120</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="О-01002"
											data-sb-product-name="ORBIS 12-24"
											data-sb-product-price="120"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/micks.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>ОПИСАНИЕ</h2> </center>
						<div class="card-body p-40">
							<p >  Смеситель-насадка ORBIS предназначена для работы с химическими анкерами.
							</p>
							<p > Смеситель имеет уникальную конструкцию, благодаря которой химические растворы эффективно смешиваются между собой, что позволяет контролировать оптимальный расход компонентов. Разаработан специально для эпоксидных химических составов.
							</p>
						</div>
           			 </div>
                    </div>
