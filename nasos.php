<?
					...
					mail("info@creant.ru", "Отзыв в насосе", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_nasos.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_nasos.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести оборудование насос yfcjc химический анкер ghjledrf jndthcnbt jndthcnbz продувка продувки отверстия отверстий 240мм объем 1046см">
        <meta name="description" content="Насос для продувки отверстий">
        <title>Насос</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Oborud">Оборудование</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/nasos.php" style="text-decoration: underline;">Насос</a></li>
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Насос</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/teh_obsl/nas_low.jpg" width="210" xoriginal="img/teh_obsl/nas.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/teh_obsl/nas.jpg"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/nas_low.jpg"  xpreview="img/teh_obsl/nas_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
					
<div class="card-body">
  Артикул: О-01008, О-01009, О-01010
</div>
</div>
<div class="card ">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">Насос</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Насос для продувки отверстий</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >Насос 240 мм (объем 536 см³)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">1650</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="О-01008"
											data-sb-product-name="Насос 240 мм"
											data-sb-product-price="1650"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/nas.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >Насос 330 мм (объем 791 см³)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">1850</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01009"
											data-sb-product-name="Насос 330 мм"
											data-sb-product-price="1850"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/nas.jpg">
											Добавить в корзину
											</a>
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >Насос 420 мм (объем 1046 см³)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">2200</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01010"
											data-sb-product-name="Насос 420 мм"
											data-sb-product-price="2200"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/nas.jpg">
											Добавить в корзину
											</a>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>Описание</h2> </center>
						<div class="card-body p-40">
							<p    >  Удобный насос, который специально предназначен для продувки создаваемых отверстий  при проведении монтажно-ремонтных или строительных работ, при помощи анкеров химических.
							</p>
							<p     >  Для подготовки отверстия и удаления ненужной пыли и грязи, Вы сможете использовать данное изделие, очищая материал за считанные секунды.
							</p>
							<p     >  Насос представлен тремя моделями: 240 мм, 330 мм и 420 мм. Они отличаются рабочим объемом: 536, 791 и 1046 см кубических соответственно. Изделие достаточно легкое и компактное, при этом имеет хорошие показатели прочности, благодаря использованному при производстве качественному материалу.
							</p>
						</div>
           			 </div>
