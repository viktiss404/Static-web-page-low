<?
					...
					mail("info@creant.ru", "Отзыв в гильзы", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_gilz.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_gilz.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<meta name="keywords" content="купить regbnm заказать приобрести гильзы гильза Гильзы Гильза ubkmps ubkmpf Ubkmps Ubkmpf [bvbxtcrbq fyrth химический анкер">
<meta name="description" content="Гильзы для отверстий пустотелом основании">
<title>Гильзы</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Oborud">Оборудование</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/gilz.php" style="text-decoration: underline;">Гильзы</a></li>
                                    </ul>
                                </li>
                                </ul>
                            </div>
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Гильзы</h1>
					...
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/teh_obsl/sech_gilz_low.jpg" width="210" xoriginal="img/teh_obsl/sech_gilz.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/teh_obsl/sech_gilz.jpg"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/sech_gilz_low.jpg"  xpreview="img/teh_obsl/sech_gilz_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
...
<div class="card-body">
  Артикул: О-01011, О-01012, О-01013, О-01014
</div>
</div>
<div class="card ">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">Гильзы</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Гильзы для отверстий пустотелом основании.</a>
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >CR-12x50</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__price"><span class="product__price-number">25</span> ₽</div>
										</td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="О-01011"
											data-sb-product-name="Гильзы CR-12x50"
											data-sb-product-price="25"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/sech_gilz.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >CR-15x85</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__price"><span class="product__price-number">35</span> ₽</div>
										</td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01012"
											data-sb-product-name="Гильзы CR-15x85"
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >CR-15x135</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__price"><span class="product__price-number">40</span> ₽</div>
										</td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01013"
											data-sb-product-name="Гильзы CR-15x135"
											data-sb-product-price="40"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/sech_gilz.jpg">
											Добавить в корзину
											</a>
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >CR-20x85</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__price"><span class="product__price-number">45</span> ₽</div>
										</td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01014"
											data-sb-product-name="Гильзы CR-20x85"
											data-sb-product-price="45"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/sech_gilz.jpg">
											Добавить в корзину
											</a>
...
<div class="tab-content" id="nav-tabContent">
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p    >Пластиковая сетчатая гильза колосально сократит расход химического состава при установке химических анкеров в пустотелые или очень порисные основания, например такие как кирпич.  
							</p>
							<p     >  При дополнительном использовании пластиковой сетчатой гильзы  смесь не будет без надобности вытекать в пустоты, а сквозь решетчатые стенки гильзы будет планомерно заполнять полую область, нужную для прочной установки анкера. На рисунке видно как экономит гильза смесь химического анкера - в пустотах создала монолитную «паутину» из химичесого состава.
							</p>
						</div>
           			 </div>
                    ...
                    <div class="card-body p-40">
						<ul class="p-40">
							<li>
								<p   >  Применяеются гильзы для стандартных по размерам глубин, где нужно заделать отверстие резьбовой шпилькой и анкер-гильзой. Максимальный показатель диаметра отверстия, в который будет входить гильза, ровна 20 мм, где глубина достигает 135 мм. Пластиковые сетчатые гильзы  имеют аккуратный вид внешнего очертания. Выполнено приспособление из качественного пластика серого цвета.
								</p>
						</ul>
                    </div>
                  </div>
  ...
  <div class="row mb-2">
	  <div class="col-md-12 w-100">
                  <div class="card w-100">
                    <div class="card-title my-2">
                    <center><h2 style="width: auto !important;">ТЕХНИЧЕСКИЕ ХАРАКТЕРИСТИКИ</h2></center> 
                    <div class="card-body">
					<center>
					<div class="tmv">
         ...
         <table class="table table-striped table-bordered">
                        <thead class="thead-dark">
							<tr>
                                ...
                                <th>Глубина отверстия, мм</th>
                                <th>Диаметр шпильки, мм</th>
