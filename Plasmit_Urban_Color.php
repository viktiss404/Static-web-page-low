<?
					...
					mail("info@creant.ru", "Отзыв в Urban color", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Urban_color.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Urban_color.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести Plasmit plasmit скуфтше [bvbxtcrbq fyrth химический анкер Urban Color краска красить rhfcrf color поверхностей gjdth[yjcntq">
        <meta name="description" content="Plasmit Urban Color ">
        <title>Покрытие Creant Plasmit™ Urban Color</title>
    ...
    <nav class="navbar navbar-expand-lg spacer one">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Plasmit">Plasmit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/Plasmit_Urban_Color.php" style="text-decoration: underline;">Urban Color</a></li>
                                    </ul>
                                </li>
                                </ul>
        ...
        <div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Plasmit Urban Color</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Plasmit/plasmit_color_low.jpg" width="210" xoriginal="img/Plasmit/plasmit_color.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Plasmit/plasmit_color.jpg"><img class="xzoom-gallery3" width="100" src="img/Plasmit/plasmit_color_low.jpg"  xpreview="img/Plasmit/plasmit_color_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
                  ...
                  <div class="card w-20">
                      ...
                      <div class="card-title">
                        <h1 class="card-title text-center sct">Plasmit Urban Color</h1>
                      </div>
                      <div class="card-body" >
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										...
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">3600</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="П-01009"
											data-sb-product-name="Plasmit Color 2000"
											data-sb-product-price="3600"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Plasmit/plasmit_color.jpg">
											Добавить в корзину
											</a>
										</td>							
                                    </tr>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
                                    <tr>
										...
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">7200</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style=" width: 125px;"
											data-sb-id-or-vendor-code="П-01010"
											data-sb-product-name="Plasmit Color 4000"
											data-sb-product-price="7200"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Plasmit/plasmit_color.jpg">
											Добавить в корзину
											</a>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p   align="justify" >Предназначена для создания защитного слоя на металлических и бетонных поверхностей. Обладает высокой проникающей способностью для бетонных оснований, создавая водонепроницаемый износостойкий слой, а также высокой адгезией к стальному основанию.
							</p>
						</div>
           			 </div>
                    ...
                    <div class="card-body p-40">
						<ul class="p-40">
							<li>
								<p align="justify"  >Покрываемые основания: металл, бетон, кирпич, пенобетон, оцинковка, дерево и композит.</p>
						</ul>
                    </div>
                  </div>
                  <div class="card-title my-2">
...
<p align="justify"  >Температура применения: от + 10 до + 40°С.
	...
	<li>
<p align="justify"  >Рабочее время: 30 минут (чем больше объем смеси, тем меньше время жизнеспособности в общей массе).
	</p>
	<li>
<p align="justify"  >
Высыхание происходит
спустя 12 часа после нанесения состава.
	</p>
	<li>
<p align="justify"  >Цвет - в соответствии с палитрой RAL</p>
<li>
<p align="justify"  >Условия эксплуатации: от - 40 до + 50°С.   
</p>
</ul>
                    </div>
            </div>
...
<p align="justify"  >  Добавить компонент Б в компонент А. 
	...
	<li/>
<p align="justify"  >  Перемешать два компонента пока состав не станет однородным по цвету и внешнему виду. При перемешивании рекомендуется использовать низкооборотную мешалку. Время перемешивания не менее 1 минуты. 
	</p>
	<li/>
<p align="justify"  >  При перемешивании необходимо захватывать участки около стенок и на дне емкости с составом. Следует избегать образования пузырей.
	</p>
		<li/>
<p align="justify"  >  Нанести состав на поверхность и равномерно распределить его используя валик или кисть.
	</p>
		<li/>
<p align="justify"  >  Состав рекомендуется использовать в течение его жизнеспособности – от 20 до 30 минут. При повышении температуры время жизнеспособности состава сокращается. 
	</p>
		<li/>
