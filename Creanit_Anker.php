<?
					...
					mail("info@creant.ru", "Отзыв в Anker", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Anker.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Anker.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <meta name="keywords" content="купить regbnm заказать приобрести Creanit creanit скуфтше [bvbxtcrbq fyrth химический анкер Anker EX-385 универсальный">
      <meta name="description" content="Creanit Anker EX-385 универсальный химический анкер для анкерных креплений на основе высокомолекулярной реактивноэпоксидной смолы">
	  <title>Химический анкер Creant CREANIT™ Anker EX-385</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Creanit">Creanit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        <li><a href="/Creanit_Anker.php" style="text-decoration: underline;">Anker EX-385</a></li>
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card">
					<h1 class="card-title text-center nsct">CREANIT Anker EX-385</h1>
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Creanit/Anker_box_low.jpg" xoriginal="img/Creanit/Anker_box.jpg" width="210"></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Creanit/Anker_box.jpg"><img class="xzoom-gallery3 xactive" src="img/Creanit/Anker_box_low.jpg" xpreview="img/Creanit/Anker_box_low.jpg" title="рисунок1" width="100"></a>
									<a href="img/Creanit/CREANIT-Anker-EX-385.jpg"><img class="xzoom-gallery3" src="img/Creanit/CREANIT-Anker-EX-385_low.jpg" title="рисунок2" width="100"></a>
                                </div>
                        </div>
                    </div>
                  ...
                  <div class="card ">
                      ...
                      <div class="card-title">
                        <h1 class="card-title text-center sct">CREANIT Anker<br> EX-385</h1>
                      </div>
                      <div class="card-body">
                        <a class="oie">Профессиональный универсальный химический анкер для анкерных креплений на основе высокомолекулярной реактивноэпоксидной смолы, не содержащей растворителей.</a> 
					  </div>
							...
							<tbody style="text-align: center; ">
									<tr>
										...
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;" data-sb-id-or-vendor-code="К-01001" data-sb-product-name="CREANIT Anker EX 385" data-sb-product-price="1900" data-sb-product-quantity="1" data-sb-product-img="img/Creanit/CREANIT-Anker-EX-385.jpg">
											Добавить в корзину
											</a>
										</td>
									</tr>
            ...
            <nav>
				...
				<div id="page-preloader" style="display: none;"><span class="spinner" style="display: none;"></span></div>
				
				<div class="nav nav-tabs mt-3 nav-a" id="nav-tab" role="tablist">
					<a class="btn btn-myst-3 nav-item mr-2" style="font-size: 1.05rem;padding-top: 0px;padding-bottom: 0px;" id="nav-opis-tab" data-toggle="tab" href="#nav-opis" role="tab" aria-controls="nav-opis" aria-selected="false">Назначение</a>
					...
					<a class="btn btn-myst-3 nav-item mr-2 active" style="font-size: 1.05rem;padding-top: 0px;padding-bottom: 0px;font-size: 1.05rem;" id="nav-otz-tab" data-toggle="tab" href="#nav-otz" role="tab" aria-controls="nav-otz" aria-selected="true">Отзывы</a>
				</div>
			</nav>	 	  

<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade" id="nav-opis" role="tabpanel" aria-labelledby="nav-opis-tab">
  <div class="row mb-2">
	  <div class="col-md-12">
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p>  Разработан
							для осуществления анкерных креплений
							высокой степени надежности    <b>в
							сжатую и растянутую зону бетона, кирпич,
							гранит, керамогранит, пустотелый кирпич,
							газобетон</b>,под высокие эксплуатационные нагрузки.  
							</p>
							<p>  Отсутствие
							усадочных деформаций позволяет
							производить монтаж арматуры и закладных
							анкерных и фундаментных болтов больших
							диаметров в отверстиях с большими
							кольцевыми зазорами. 
							</p>
							<p>  Специально разработан для применения в отверстиях,
                            выполненных с использованием установок алмазного бурения и
                            имеющих гладкую отшлифованную внутреннюю поверхность.
							</p>
...
<p>   первичное
	схватывание происходит от 7 минут после
	инъекции состава (в зависимости
	температуры основания), полное отверждение
	состава — 12 часов.   
	</p>
	</li><li>
<p>   цвет
...
<p>   Перед
	...
	+15°С, поместить тубу в тёплую воду на
	5—10 минут.   
	</p>
	</li><li>
<p>   Использовать
...
<div class="tab-pane fade active show" id="nav-otz" role="tabpanel" aria-labelledby="nav-otz-tab">
	<div class="row mb-2">
		<div class="col-md-12">
		<div class="card w-100">
                    <div class="card-title my-2">
