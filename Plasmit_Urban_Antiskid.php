<?
					...
					mail("info@creant.ru", "Отзыв в Urban Antiskid", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Urban_Antiskid.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Urban_Antiskid.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести Plasmit plasmit скуфтше [bvbxtcrbq fyrth химический анкер Urban Antiskid противоскользящий антискользкий fynbcrjkmprbq ghjnbdjcrjkmpzobq поверхностей gjdth[yjcntq">
        <meta name="description" content="Plasmit Urban Antiskid для создания противоскользящей поверхности">
        <title>Покрытие Creant Plasmit™ Urban Antiskid</title>
    ...
    <nav class="navbar navbar-expand-lg spacer one">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Plasmit">Plasmit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/Plasmit_Urban_Antiskid.php" style="text-decoration: underline;">Urban Antiskid</a></li>
        ...
        <div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Plasmit Urban Antiskid</h1>
					
						<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Plasmit/plasmit_urban_antiskid_low.jpg" width="210" xoriginal="img/Plasmit/plasmit_urban_antiskid.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Plasmit/plasmit_urban_antiskid.jpg"><img class="xzoom-gallery3" width="100" src="img/Plasmit/plasmit_urban_antiskid_low.jpg"  xpreview="img/Plasmit/plasmit_urban_antiskid_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                        </div>

                    <div class="card-body">
					  	Артикул: П-01001, П-01002, П-01003
                      </div>
                  </div>
                  <div class="card w-20">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">Plasmit Urban Antiskid</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Инновационное противоскользящее покрытие на основе полиуретана модифицированного наночастицами углерода</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >2250 гр</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">3940</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="П-01001"
											data-sb-product-name="Plasmit urban antiskid"
											data-sb-product-price="3940"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/plasmit_urban_antiskid.jpg">
											Добавить в корзину
											</a>
										</td>							
                                    </tr>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
                                    <tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >5000 гр</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">8750</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style=" width: 125px;"
											data-sb-id-or-vendor-code="П-01002"
											data-sb-product-name="Plasmit Urban Antiskid"
											data-sb-product-price="8750"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/plasmit_urban_antiskid.jpg">
											Добавить в корзину
											</a>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
                                    <tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >6800 гр</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">11900</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available; width: 125px;"
											data-sb-id-or-vendor-code="П-01003"
											data-sb-product-name="Plasmit Urban Antiskid"
											data-sb-product-price="11900"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/plasmit_urban_antiskid.jpg">
											Добавить в корзину
											</a>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p   align="justify" >Предназначено для создания противоскользящей поверхности на металлических, бетонных и керамических поверхностях.
Обладает высокой проникающей способностью для бетонных оснований, создавая водонепроницаемый износостойкий слой, а также высокой адгезией к стальному основанию
Покрываемые основания: бетон, металл, оцинковка, пластики, композитные изделия, асфальтобетон, гранит, керамогранит.
							</p>
						</div>
           			 </div>
                    ...
                    <div class="card-body p-40">
						<ul class="p-40">
							<li>
								<p align="justify"  > Покрывают основания: бетон, металл, оцинковка, пластики, композитные изделия, асфальтобетон</p>
						</ul>
                    </div>
                  </div>
                  <div class="card-title my-2">
						...
						<div class="card-body p-40">
							<ul class="p-40">
								<li/>
									<p   align="justify" >
                                    устойчив к агрессивным средам;</p>
								<li/>
									<p   align="justify"  >
                                    эластичен ;</p>
								<li/>
  ...
  <div class="row mb-2">
	  <div class="col-md-12">
                  <div class="card w-100">
                    ...
                    <ul class="p-40">
	<li>
<p align="justify"  >Внешний вид: жидкость низкой вязкости
	</p>
	<li>
<p align="justify"  >Плотность: 1,425 кг/литр
	</p>
	<li>
<p align="justify"  >
Покрытие наносится на сухое основание с температурой поверхности от +5 до  + 25°С и температурой воздуха от  +5 до  + 30°С. 
	</p>
	<li>
<p align="justify"  >Необходимо исключить попадание осадков на материал в первые 12 часов после нанесения на обрабатываемую поверхность</p>
<li>
<p align="justify"  > Для нанесения состава используются кисть, валик, шпатель, безвоздушное распыление   
</p>
<li>
<p align="justify"  >
Полное высыхание покрытия - 3 часа
</p>
<li>
<p align="justify"  >
Содержит расстворитель
</p>
<li>
<p align="justify"  >
Имеет запах
...
<li>
<p align="justify"  >
Цвет  - в соответствии с палитрой RAL.
</p>
<li>
<p align="justify"  >
Разбавителем служит: ксилол, сольвент.
</p>
<p align="justify"  >
Применяется на ступенях, на пандусах и на наклонных поверхностях;     
</p>
</ul>
                    </div>
            </div>
...
солнечного света. После вскрытия упаковки срок хранения 2 недели. Возможно использовать разбавитель (ксилол, сольвент). В ненарушенной упаковке срок годности составляет 12 месяцев.</a>
                    </div>
            </div>
...
<!--
        <div class="card-title my-2">
			...
			<div class="table-responsive-sm" style="max-width: 100%; overflow: auto;" >
        
        <center> <table class="table table-striped table-bordered w-100 d-block d-md-table" >
                        <thead class="thead-dark">
							<tr>
								<th scope="col" >
									Температура
...
<p>  <b> ¹
      ...
      <p  >  <b> ²
			...
			нагрузки 
                    ...
                    <div class="card-title my-2">
                    <center><h2>ГЕОМЕТРИЧЕСКИЕ ХАРАКТЕРИСТИКИ И РАСХОД</h2></center>
                    <div class="card-body ">
                    <center>
        ...
        -->
                    ...
                    <ul  class="p-40">
                        ...
                        <li/>
                            <p align="justify"  >При использовании применять средства индивидуальной защиты (перчатки, очки).</p>
                    	<li/>
                    	    <p align="justify"  >Перед использованием тщательно перемешать.</p>
                    
                    	<li/>
                            <p align="justify"  > Время отверждения до нанесения последующих слоев при температуре воздуха 20°С и относительной влажности воздуха 75% - 12 часов.</p>
                    	<li/>
                            <p align="justify"  > Способ нанесения: кисть; валик; безвоздушное напыление.</p>
