<?
					...
					mail("info@creant.ru", "Отзыв в Anker Solution", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Anker_Solution.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Anker_Solution.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести Creanit creanit скуфтше [bvbxtcrbq fyrth химический анкер Anker Solution эпоксидная ремонтно-востановительная композиция">
        <meta name="description" content="Creanit Anker Solution эпоксидная ремонтно-востановительная композиция">
        <title>Химический анкер Creant CREANIT™ Anker Solution</title>
    ...
    <nav class="navbar navbar-expand-lg spacer one">
                            ...
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Creanit">Creanit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        ...
                                        <li><a href="/Creanit_Solution.php" style="text-decoration: underline;">Solution</a></li>
        ...
        <div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">CREANIT Solution</h1>
					...
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Creanit/CREANIT_Solution_low.jpg" width="210" xoriginal="img/Creanit/CREANIT_Solution.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Creanit/CREANIT_Solution.jpg"><img class="xzoom-gallery3" width="100" src="img/Creanit/CREANIT_Solution_low.jpg"  xpreview="img/Creanit/CREANIT_Solution_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
					
                      <div class="card-body">
					  	Артикул: К-01004, К-01004
                      </div>
                  </div>
                  <div class="card w-20">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">CREANIT Solution</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie"> Эпоксидная ремонтно-востановительная композиция. Обладает высокой проникающей способностью для бетонных оснований, создавая водонепроницаемый износостойкий слой.</a> 
					  </div>
					  <table class="table table-bordered w-100"style="margin-bottom:0px;">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
									<td style=" vertical-align: middle;" >1800 гр</td>						
										<td style=" vertical-align: middle;" ><div class="product__price"><span class="product__price-number">3200</span> ₽</div></td>
										<td style=" vertical-align: middle;" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;"
											data-sb-id-or-vendor-code="К-01004"
											data-sb-product-name="CREANIT Anker Solution"
											data-sb-product-price="3200"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/CREANIT_Solution.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
							<tr>
										<td style=" vertical-align: middle;" >3600 гр</td>						
										<td style=" vertical-align: middle;" ><div class="product__price"><span class="product__price-number">5800</span> ₽</div></td>
										<td style=" vertical-align: middle;" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;"
											data-sb-id-or-vendor-code="К-01005"
											data-sb-product-name="CREANIT Anker Solution"
											data-sb-product-price="5800"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/CREANIT_Solution.jpg">
											Добавить в корзину
											</a>
                  ...
                  <div class="card w-100">
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p   align="justify" >
							    Ремонтно-восстановительная композиция не дает усадки после отверждения, характеризуется высокой адгезией c поверхностью и не боится битумного выделения асфальтабетона.
							</p>
							<p >
							    Предназначена для восстановления бетонных поверхностей, ремонта трещин, заделывания отверстий на горизонтальной поверхности. 
							</p>
							<p >
							    Покрываемые основания: бетон, кирпич, пенобетон, дерево, композит.
							</p>
						</div>
           			 </div>
...
<!--
                    ...
                    <div class="card-body p-40">
						<ul class="p-40">
							...
							<li>
								<p align="justify"  >   крепления
								промышленного оборудования  
								</p>
							<li>
								<p align="justify"  >   организации
							...
							<li>
								<p align="justify"  >   реставрационные
                  ...
                  <div class="card-title my-2">
						...
						<div class="card-body p-40">
							<ul class="p-40">
								...
								<li/>
									<p   align="justify" >
                                     создает гидроизоляционный защитный слой ; </p>
								<li/>
									<p   align="justify"  >
                                    не токсичен; </p>
								<li/>
									<p   align="justify"  >
									высокая эффективность и превосходные технические характеристики в соответствии с международными стандартами.</p>
							</ul>
						</div>
            		</div>
		  </div>  		  
  ...
  <div class="row mb-2">
	  <div class="col-md-12">
                  <div class="card w-100">
                    ...
                    <ul class="p-40">
                    	<li>
                            <p align="justify"  >Температура применения: от + 10 до + 40°С.</p>
                    	<li>
                            <p align="justify"  >Рабочее время: 10 минут (чем больше объем смеси, тем меньше время жизнеспособности в общей массе).</p>
                    	<li>
                            <p align="justify"  >Первичное схватывание происходит спустя 1 часа после нанесения состава, полное отверждение состава — 12 часов.</p>
                    	<li>
                            <p align="justify"  >Цвет - серый</p>
                        <li>
                            <p align="justify"  > Условия эксплуатации: от - 40 до + 50°С.</p>
                    </ul>
                    </div>
            </div>
...
солнечного света. После вскрытия упаковки срок хранения 2 недели. Возможно использовать разбавитель (ксилол, сольвент). Срок годности составляет 18 месяцев.</a>
                    </div>
            </div>
...
<p align="justify"  >Добавить компонент Б в компонент А.  
	...
	<li/>
<p align="justify"  > Перемешать два компонента пока состав не станет однородным по цвету и внешнему виду. При перемешивании рекомендуется использовать низкооборотную мешалку. Время перемешивания не менее 1 минуты. При перемешивании необходимо захватывать участки около стенок и на дне емкости с составом.
Следует избегать образования пузырей.
	</p>
	<li/>
<p align="justify"  >Вылить необходимое количество сотстава на поверхность и равномерно распределить его используя шпатель.
	</p>	<li/>
<p align="justify"  >Ремонтный состав рекомендуется использовать в течение его жизнеспособности – от 2 до 10 минут.  
	</p>
		<li/>
<p align="justify"  >При повышении температуры время жизнеспособности клея сокращается. 
	</p>
	<li/>
