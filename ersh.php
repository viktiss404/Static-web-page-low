<?
					...
					mail("info@creant.ru", "Отзыв в ершиках", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_erch.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_erch.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<meta name="keywords" content="купить regbnm заказать приобрести химический анкер ершики thibrb ершик thibr Thibr Ершики диаметр Lbfvtnh lbfvtnh Ø 8-12 12-14 14-20 20-30">
<meta name="description" content="Ершики для прочистки отверстия">
<title>Ершики</title>
                        ...
                        <center>
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Oborud">Оборудование</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        <li><a href="/miks_nasad.php" style="text-decoration: underline;">Миксер-насадка</a></li>
                                        <li><a href="/miks_nasad_ydl.php">Удлинитель миксера</a></li>
                                        <li><a href="/ersh.php" style="text-decoration: underline;">Ершики</a></li>
...
<div class="container mt-2">
    <div class="linetraacard card-deck">
        <div class="card w-20">
			<h1 class="card-title text-center nsct">Ершик</h1>
			
			<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/teh_obsl/erch_low.jpg" width="210" xoriginal="img/teh_obsl/erch.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/teh_obsl/erch.jpg"><img class="xzoom-gallery3" width="100" src="img/teh_obsl/erch_low.jpg"  xpreview="img/teh_obsl/erch_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>

<div class="card-body">
  Артикул: О-01004, О-01005, О-01006, О-01007
</div>
</div>
<div class="card ">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">Ершик</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Металлическая щетка для очистки отверстий</a> 
					  </div>
						...
						<table class="table table-bordered w-100"style="margin-bottom:0px;">
							...
							<tr>
								<th scope="col" style="width: 25%;padding-left:12,5%;padding-right:12,5%">Тип</th>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >С-10/80/300 (Ø 8-12 мм)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">400</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="О-01004"
											data-sb-product-name="Ершик 10/80/300"
											data-sb-product-price="400"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/erch.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >С-13/80/300 (Ø 12-14 мм)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">480</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01005"
											data-sb-product-name="Ершик 13/80/300"
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >С-18/80/300 (Ø 14-20 мм)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">550</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01006"
											data-sb-product-name="Ершик 18/80/300"
					...
					<div class="price">
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >С-28/80/300 (Ø 20-30 мм)</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">620</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%; " >
											<div class="product__quantity"></div>
										</td>							
										<td style="padding:0px;">
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available;display: inline-block;"
											data-sb-id-or-vendor-code="О-01007"
											data-sb-product-name="Ершик 28/80/300"
											data-sb-product-price="620"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/teh_obsl/erch.jpg">
											Добавить в корзину
											</a>
...
<div class="tab-content" id="nav-tabContent">
  ...
  <div class="tab-pane fade show active" id="nav-opis" role="tabpanel" aria-labelledby="nav-opis-tab">
	  ...
	  <div style="padding: none;padding-right: 0px;" class="col-lg-12">
                  <div class="card w-100">
                    <div class="card-title my-2">
                    <center><h2>ОПИСАНИЕ</h2> </center>
						<div class="card-body p-40">
							<p>  Металлическая щетка - является неотъемлемым атрибутом при правильном выполнении техники установки химических анкеров.
							</p>
							<p>  А именно, после первого этапа - высверливания отверстия требуемого по проекту диаметра - согласно технологии, требуется провести тщательную очистку данного отверстия от продуктов сверления (пыли, мелких камней и крошки основания).
							</p>
							<p>  Металлическая щетка  должна совпадать по диаметру с отверстием, которое нужно прочистить. И учтите, если пренебрегать использованием металлической щетки или использовать одну «универсальную» щетку для отверстий всех диаметров, Вы автоматически нарушаете технологический процесс установки химических анкеров.
							</p>
						</div>
           			 </div>
                    </div>
