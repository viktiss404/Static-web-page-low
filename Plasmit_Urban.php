<?
					...
					mail("info@creant.ru", "Отзыв в Urban", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Urban.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Urban.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <link href="img/favicon.ico" rel="shortcut icon" type="image/x-icon">
        ...
        <meta name="keywords" content="купить regbnm заказать приобрести Plasmit plasmit скуфтше [bvbxtcrbq fyrth химический анкер Urban защиты защита pfobnf поверхностей gjdth[yjcntq">
        <meta name="description" content="Plasmit Urban для защиты металлических и бетонных поверхностей от воздействия агрессивных сред">
        <title>Покрытие Creant Plasmit™ Urban</title>
    ...
    <nav class="navbar navbar-expand-lg spacer one">
                        ...
                        <center>
                            <div class="av" >
                                ...
                                <li id="block" ><a class="js_bl" href="/main.php#Plasmit">Plasmit</a>
                                    <ul class="sub_block" style="z-index: 99999;padding-left: 4px;">
                                        <li><a href="/Plasmit_Urban.php" style="text-decoration: underline;">Urban</a></li>
        ...
        <div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card w-20">
					<h1 class="card-title text-center nsct">Plasmit Urban</h1>
					
					<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Plasmit/plasmit_urban_low.jpg" width="210" xoriginal="img/Plasmit/plasmit_urban.jpg" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Plasmit/plasmit_urban.jpg"><img class="xzoom-gallery3" width="100" src="img/Plasmit/plasmit_urban_low.jpg"  xpreview="img/Plasmit/plasmit_urban_low.jpg" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
					  	Артикул: П-01004, П-01005, П-01006
                      </div>
                  </div>
                  <div class="card w-20">

                      <div class="card-title">
                        <h1 class="card-title text-center sct">Plasmit Urban</h1>
                      </div>
                      <div class="card-body" >
                        <a class="oie">Инновационное карбон-полимерное покрытие на основе полиуретана, модифицированного наночастицами углерода</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >1800 гр</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">3200</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="П-01004"
											data-sb-product-name="Plasmit Urban 1800"
											data-sb-product-price="3200"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Plasmit/plasmit_urban.jpg">
											Добавить в корзину
											</a>
										</td>							
                                    </tr>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
                                    <tr>
										...
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">7100</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style=" width: 125px;"
											data-sb-id-or-vendor-code="П-01005"
											data-sb-product-name="Plasmit Urban 4000"
											data-sb-product-price="6400"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Plasmit/plasmit_urban.jpg">
											Добавить в корзину
											</a>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
                                    <tr>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >5400 гр</td>						
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">9600</span> ₽</div></td>
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" >
											<div class="product__quantity"></div>
										</td>							
										<td >
											<a class="add-to-cart btn btn-myst-3" style="width: -moz-available; width: 125px;"
											data-sb-id-or-vendor-code="П-01006"
											data-sb-product-name="Plasmit Urban 5400"
											data-sb-product-price="9600"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Plasmit/plasmit_urban.jpg">
											Добавить в корзину
											</a>
			...
			<div class="nav nav-tabs mt-3 nav-a" id="nav-tab" role="tablist">
					...
					<a class="btn btn-myst-3 nav-item mr-2" style="font-size: 1.05rem;padding-top: 0px;padding-bottom: 0px;" id="nav-otz-tab" data-toggle="tab" href="#nav-otz" role="tab" aria-controls="nav-otz" aria-selected="false">Отзывы</a>
				</div>
</nav>
                  ...
                  <div class="card" >
                    ...
                    <center><h2>НАЗНАЧЕНИЕ</h2> </center>
						<div class="card-body p-40">
							<p   align="justify" >Предназначено для защиты металлических и бетонных поверхностей от воздействия агрессивных сред: жиров, масел и различных химикатов.
                                ...
                                Покрываемые основания: бетон, металл, оцинковка, пластики, композитные изделия, асфальтобетон
							</p>
						</div>
           			 </div>
...
<p align="justify"  >Внешний вид: жидкость низкой вязкости
	...
	<li>
<p align="justify"  >Плотность: 1,125 кг/литр
	</p>
	<li>
<p align="justify"  >
...
солнечного света. Срок годности в ненарушенной упаковке составляет 12 месяцев.</a>
                    </div>
            </div>
...
<p align="justify"  >При использовании применять средства индивидуальной защиты (перчатки, очки).
	...
	<li/>
<p align="justify"  > Время отверждения до нанесения последующих слоев при температуре воздуха 20°С и относительной влажности воздуха 75% - 12 часов. 
	</p>
		<li/>
<p align="justify"  > Перед применением тщательно перемешать. 
	</p>
	<li/>
<p align="justify"  > Способ нанесения: кисть; валик; безвоздушное напыление. 
	</p>
...
<div class="tab-pane fade" id="nav-otz" role="tabpanel" aria-labelledby="nav-otz-tab">
	<div class="row mb-2">
		...
		<div class="card">
                    <div class="card-title my-2">
                    <center><h2>Отзывы к товару</h2> </center>
						<div class="card-body p-40">
