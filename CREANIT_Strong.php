<?
					...
					mail("info@creant.ru", "Отзыв в Anker strong", $z[1] . "\n" . $z[2] . "\n" . $z[3]); // сообщение на ваш email о новом отзыве

						$fp = fopen("cmnt/comments_Anker_strong.txt", "a+"); // режим записи
					...
					$fp = @fopen("cmnt/comments_Anker_strong.txt", "r"); // режим чтения
					if ($fp) {
						while (!feof($fp)) {
...
<html lang="ru">
  <head>
      ...
      <meta name="keywords" content="купить regbnm заказать приобрести Creanit creanit скуфтше [bvbxtcrbq fyrth химический анкер Anker EK-385 холод отрицательные температура температуры морозоустойчивый минус">
      <meta name="description" content="Creanit Anker Strong EK-385 химический анкер">
	  <title>Химический анкер Creant CREANIT™ Anker Strong EK-385</title>
 ...
 <nav class="navbar navbar-expand-lg spacer one " style="background-color: black">
	...
	<div class="container mt-2">
                  <div class="linetraacard card-deck">
                    <div class="card">
					<h1 class="card-title text-center nsct">CREANIT Anker<br> EK-385</h1>
						<div class="container">
                        <div style="text-align:center;">
                                <div class="mt-4">
                                    <div class="a">
                                    <center><img class="xzoom3" src="img/Creanit/strong_low.JPG" width="210" xoriginal="img/Creanit/strong.JPG" /></center>
                                    </div>
                                </div>
                                
                                <div class="xzoom-thumbs" style="text-align:center;">
                                    <a href="img/Creanit/strong.JPG"><img class="xzoom-gallery3" width="100" src="img/Creanit/strong_low.JPG"  xpreview="img/Creanit/strong_low.JPG" title="рисунок1"></a>
                                </div>
                        </div>
                    </div>
                  ...
                  <div class="card ">
                      ...
                      <div class="card-title">
                        <h1 class="card-title text-center sct">CREANIT Anker<br> EK-385</h1>
                      </div>
                      <div class="card-body" >
					  	<a class="oie">Высокоэффективное инновационное противоскользящее покрытие на основе полиуретана, модифицированного наночастицами углерода с добавлением корунда.</a> 
					  </div>
						...
						<thead class="thead-dark">
							...
							<tbody style="text-align: center; ">
									<tr>
										...
										<td style=" vertical-align: middle; padding-left:12,5%;padding-right:12,5%" ><div class="product__price"><span class="product__price-number">320</span> ₽</div></td>
										...
										<td style="padding:0px;">
											...
											data-sb-id-or-vendor-code="4711310"
											data-sb-product-name="CREANIT Anker EK-385"
											data-sb-product-price="2400"
											data-sb-product-quantity= "1"
											data-sb-product-img="img/Creanit/strong.JPG.jpg">
											Добавить в корзину
											</a>
										</td>							
									</tr>
